    ...
    return (
        <main className='flex flex-col md:order-2 ml-9 pl-5 pt-10'>
            ...
            <form method='' className="mt-6 grid grid-flow-row justify-start">
                <div className="mb-4">
                    <label for="name" className="black-color w-80 block mb-2 text-sm font-medium text-gray-900 dark:text-white light-font">Full name</label>
                ...
                <div className="mb-4">
                    <label for="email" className="black-color w-80 block mb-2 text-sm font-medium text-gray-900 dark:text-white light-font">Email address</label>
                    <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Email" required={true} />
                </div>

                <div className="mb-4">
                    <label for="password" className="black-color w-80 block mb-2 text-sm font-medium text-gray-900 dark:text-white light-font">Your password</label>
