                        ...
                        <div className="flex w-full justify-end items-end mt-10">
                            <div className='mb-[25rem] mr-[3rem] ml-[3rem]'>
                                ...
                                <div className='flex justify-center items-center mt-[-25rem]'>
                                    <Image className="rounded-lg z-0 shadow-lg company-profile-image" alt={job?.companyName} src={previewUrl || job?.companyProfileImage} height={0} width={0} />
                                </div>
                            ...
                            <div className="max-w-md justify-end items-end ml-10 mb-[14.3rem]">
                                ...
                                <div className='mt-4'>
                                    ...
                                    <Textarea id="jobDescription" name="jobDescription" value={job?.jobDescription} placeholder="Deskripsi pekerjaan" onChange={handleChange} required={true} rows={10} cols={50} />
                                </div>
